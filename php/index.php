  ...
  <body data-api-chelgortrans="<?=$chelgortrans?>" data-api-static="<?=$static?>" data-route-id="<?=$id?>"><?php require_once("../images/svg/symbols.svg"); ?>
    <main class="l-page">
      ...
      <div class="route-list">
        <div class="l-wrapper" data-scrollbar="data-scrollbar">
          <div id="output-all"></div>
        </div>
      </div>
      <div class="search">
        <div class="l-wrapper">
          <div class="search__wrapper"><a class="btn-search" href="./02.php">
              <button class="btn-search__button">Поиск маршрута</button></a>
          </div>
        </div>
      </div>
    </main>
